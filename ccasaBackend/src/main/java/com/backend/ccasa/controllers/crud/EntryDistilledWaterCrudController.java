...
public class EntryDistilledWaterCrudController {

	private final IEntryDistilledWaterCrudService service;

	public EntryDistilledWaterCrudController(IEntryDistilledWaterCrudService service) {
