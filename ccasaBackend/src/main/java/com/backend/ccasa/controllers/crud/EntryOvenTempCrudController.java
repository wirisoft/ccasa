...
public class EntryOvenTempCrudController {

	private final IEntryOvenTempCrudService service;

	public EntryOvenTempCrudController(IEntryOvenTempCrudService service) {
