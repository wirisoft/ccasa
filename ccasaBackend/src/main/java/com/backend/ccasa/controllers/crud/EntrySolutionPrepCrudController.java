...
public class EntrySolutionPrepCrudController {

	private final IEntrySolutionPrepCrudService service;

	public EntrySolutionPrepCrudController(IEntrySolutionPrepCrudService service) {
	...
	public ResponseEntity<byte[]> pdf(@PathVariable Long id) {
		...
		return ResponseEntity.ok()
			...
			.header("Content-Disposition", "inline; filename=\"prep-solucion-" + id + ".pdf\"")
			.body(bytes);
	}
