...
public class EntryDryingOvenCrudController {

	private final IEntryDryingOvenCrudService service;

	public EntryDryingOvenCrudController(IEntryDryingOvenCrudService service) {
