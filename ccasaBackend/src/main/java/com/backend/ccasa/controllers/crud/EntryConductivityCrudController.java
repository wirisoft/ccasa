...
public class EntryConductivityCrudController {

	private final IEntryConductivityCrudService service;

	public EntryConductivityCrudController(IEntryConductivityCrudService service) {
